...
/**
 * 类名称：EmployeeReplaceImpl.java<br/>
 * 日期：2015年12月31日 下午2:48:45<br/>
 * 类描述：员工替换服务<br/>
 * 修改说明（时间、人、详细备注）：<br/>
 ...
 * @version 1.0.0
 */
@Service("employeeReplaceService")
public class EmployeeReplaceImpl implements IReplaceService {
	...
	public String replace(Body replace, String sql){
		return supplierService.replaceEmployee(replace, sql);
	}
