...
/**
 * 类名称：AdviserReplaceImpl.java<br/>
 * 日期：2015年12月31日 下午2:47:45<br/>
 * 类描述：班主任替换服务<br/>
 * 修改说明（时间、人、详细备注）：<br/>
 ...
 * @version 1.0.0
 */
@Service("adviserReplaceService")
public class AdviserReplaceImpl implements IReplaceService {
	...
	public String replace(Body replace, String sql){
		return supplierService.replaceAdviser(replace, sql);
	}
