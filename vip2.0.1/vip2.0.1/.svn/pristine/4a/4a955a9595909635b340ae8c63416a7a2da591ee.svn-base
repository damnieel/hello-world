	...
	$.fn.pagination = function(maxentries, opts){
		...
		function paginationClickHandler(evt){
			var links, 
			    ...
			    setCookie("pageId",new_current_page);
		...
		/**********陈海*******************************************************/
		  ...
		  { 
		      var Days = 1; 
		      var exp = new Date(); 
		      exp.setTime(exp.getTime() + Days*60*2*1000); 
	   ...
	   /************************************************************************/
		...
		// -----------------------------------
		if(getCookie("pageId")!=null && opts.is_search == false ){
		  opts.current_page = parseInt(getCookie("pageId"));
		}
		...
		if(opts.load_first_page) {
			opts.callback(current_page,10, containers);
		}
